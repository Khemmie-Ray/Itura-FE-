...
const DemoCard = () => {
  return (
    <div className="bg-white/10 rounded-[21px] lg:p-8 md:p-6 p-4 backdrop-filter-blur w-[95%] mx-auto">
      <div className="bg-darkBg rounded-[21px] lg:p-6 md:p-5 p-4 z-20 relative py-10">
        <div className="text-center">
          <h1 className="lg:text-[64px] md:text-[52px] text-[48px] font-[500] bg-gradient-to-b from-[#F5F4F7] via-[#F3F2F5] to-[#B0ADBF] inline-block text-transparent bg-clip-text leading-10 mb-4">
        ...
        <div
          className="mt-10 rounded-4xl lg:p-6 md:p-4 p-3 bg-[#080514]/40 border border-white/20 rounded-[34px] lg:w-[70%] md:w-[80%] w-[90%] mx-auto"
        >
