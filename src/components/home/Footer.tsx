  ...
  return (
    <footer className="bg-darkBg px-6 mx-auto  text-white font-dmSans">
      <div className="bg-footerBg">
        <div className="bg-gradient-to-b from-[#B9A7C3] to-[#FFFFFF]/0 rounded-[44px] p-0.5">
          <div className="bg-footerBg rounded-[44px]">
            <div className="flex lg:justify-between w-[100%] lg:w-[80%] md:w-[80%] mx-auto py-20 lg:flex-row md:flex-row flex-col px-8 lg:px-2 md:px-2 ">
              <div className="lg:w-[30%] md:w-[30%] w-[100%]">
                <Image
                  ...
                  width={202}
                  height={160}
                  className="mb-6 lg:w-[70%] md:w-[70%] w-[100%]"
                />
              </div>
              <div className="flex justify-between  w-[100%] lg:w-[60%] md:w-[60%] mx-auto lg:flex-row md:flex-row flex-col">
                <div className="w-[100%] lg:w-[64%] md:w-[64%] flex justify-between lg:my-0 md:my-0 my-16">
        ...
        <div className="flex justify-between items-center w-[90%] mx-auto border-t border-white/10 py-8 lg:flex-row md:flex-row flex-col text-[14px] text-center lg:text-left md:text-left">
          <p className="mb-4 order-2 lg:order-1 md:order-1 font-thin">
            &copy; {currentYear} EncompassWell All rights reserved.
          </p>
          <div className="w-[70%] lg:w-[30%] md:w-[30%] flex justify-between lg:mb-3 md:mb-3 mb-8 mx-auto order-1 lg:order-2 md:order-2">
          ...
          <div className="flex mb-3 order-3">
            ...
            <div className="p-3 bg-white rounded-full text-black mr-4">
            <a href="https://x.com/Ituraorg" target="blank">
            <RiTwitterXFill />
              </a>
            </div>
