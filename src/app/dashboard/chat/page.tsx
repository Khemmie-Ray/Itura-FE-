...
const Chat: React.FC = () => {
  ...
  return (
    <main className="flex flex-col lg:min-h-[80vh] md:min-h-[80vh] min-h-[90vh] relative z-30">
      ...
      <section className="lg:w-[80%] md:w-[80%] w-[90%] mx-auto my-auto bg-white/15 border-white/20 rounded-3xl lg:border md:border">
        <div className="flex items-center w-[100%] rounded-full border py-2 px-4 shadow-lg shadow-grey/20 bg-white/15 border-white/20">
          <input
            type="text"
